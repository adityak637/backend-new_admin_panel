                     ...
                     <td align="left" style="padding: 20px 25px; text-align: left; font-size: 16px; line-height: 20px;">
                        <table cellspacing="0" cellpadding="0" width="100%">
                           <tbody>
                              <tr>
                                 <td> <b
                                       style="color:#444444; font-weight: normal; font-family: Calibri, Helvetica, sans-serif;">Hello,{{$user->name}}</b>
                                 </td>
                              </tr>
                              <tr>
                                 <td
                                    style="padding: 20px 0 0 0;color:#444;font-family: Calibri, Helvetica, sans-serif;">
                                    We are sending you this email to confirm that your password has been successfully
                                    changed. </td>
                              </tr>
                              <tr>
                                 <td style=" color:#444444;padding-top:20px; line-height:20px; " valign="top"
                                    align="left"> Kind regards,<br><strong>Travender team</strong> </td>
                              </tr>
                           </tbody>
                        </table>
                     </td>
