                     ...
                     <td align="left" style="padding: 20px 25px; text-align: left; font-size: 16px; line-height: 20px;">
                        <table cellspacing="0" cellpadding="0" width="100%">
                           <tbody>
                              <tr>
                                 <td> <b
                                       style="color:#444444; font-weight: normal; font-family: Calibri, Helvetica, sans-serif;">Hi, {{$user->name}}</b>
                                 </td>
                              </tr>
                              <tr>
                                 <td style="padding: 20px 0 0 0;color:#444444;"> We are sending you this email following
                                    your recent request to reset your password. </td>
                              </tr>
                              <tr>
                                 <td style="padding: 20px 0 0 0;color:#444444;"> Your verification code is {{$user->verifycode}}
                                 </td>
                              </tr>
                              <tr>
                                 <td style="padding: 20px 0 0 0;color:#444444;"> To proceed with resetting your password
                                    please click <a style="color:#3075c6; font-weight:600; text-decoration:underline;"
                                       href="http://travander.in/reset-password?username={{$user->email}}">here </a> </td>
                              </tr>
                              <tr>
