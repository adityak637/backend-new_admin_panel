                     ...
                     <td align="left" style="padding: 20px 25px; text-align: left; font-size: 16px; line-height: 20px;">
                        <table cellspacing="0" cellpadding="0" width="100%">
                           <tbody>
                              ...
                              <tr>
                                 <td style="padding: 20px 0 0 0;color:#444444;"> Welcome at world of Travander </td>
                              </tr>
                              <tr>
                                 <td style="padding: 20px 0 0 0;color:#444444;"> To proceed with create your password
                                    please click <a style="color:#3075c6; font-weight:600; text-decoration:underline;"
                                       href="http://travander.in/update-password?key={{$user->security_key}}">here </a> </td>
                              </tr>
                              <tr>
